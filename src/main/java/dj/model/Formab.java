...
/**
 * The persistent class for the formab database table.
 * 
 */
@JsonIgnoreProperties({"hibernateLazyInitializer", "handler" })
@Entity
@NamedQuery(name="Formab.findAll", query="SELECT f FROM Formab f")
public class Formab implements Serializable {
	...
	public Integer getFormabid() {
		return this.formabid;
	}

	public void setFormabid(Integer formabid) {
		this.formabid = formabid;
	}
